...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_5 = "SELECT * FROM ogrenci WHERE ogrno < 10 AND ogrno > 5 AND cinsiyet = 'K';";
    ...
    String QUESTION_7 = "SELECT * FROM ogrenci ORDER BY ogrno ASC LIMIT 1;";
